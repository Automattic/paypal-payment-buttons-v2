...
export default function PayPalPaymentButtonsEdit( { attributes, setAttributes } ) {
	...
	}, [ productName, price, currencyCode, productDescription, returnUrl, setAttributes ] );
	...
	}, [ resourceId, productName, price, currencyCode, productDescription, returnUrl, paymentLink, setAttributes ] );
	...
	// Connected + has a resourceId — show the created button preview.
	if ( isApiManaged && resourceId && paymentLink ) {
		return (
			<div { ...blockProps }>
				<div className="jetpack-paypal-payment-buttons__preview">
					...
					<div className="jetpack-paypal-payment-buttons__button-preview">
						<a
							href={ paymentLink }
							className="jetpack-paypal-payment-buttons__button"
							target="_blank"
					...
					<div className="jetpack-paypal-payment-buttons__preview-details">
				...
				<InspectorControls>
					<PanelBody
						title={ __( 'Product Details', 'jetpack-paypal-payments' ) }
						initialOpen={ true }
					>
						<TextControl
						...
						<TextareaControl
							...
							help={ __( 'Shown to customers at checkout.', 'jetpack-paypal-payments' ) }
						/>
						<TextControl
						...
						>
							{ isCreating
								? __( 'Updating…', 'jetpack-paypal-payments' )
	...
	// Connected but no button created yet — show the creation form.
	return (
		<div { ...blockProps }>
			<div className="jetpack-paypal-payment-buttons__create-form">
				...
				<h3>{ __( 'Create PayPal Button', 'jetpack-paypal-payments' ) }</h3>
				...
				>
					{ isCreating
						? __( 'Creating…', 'jetpack-paypal-payments' )
